...
\newcommand\quelle[1]{{%
 ...
 \moveleft.5\hoffset\centerline{210 Hudson Street $\bullet$ Hoboken, NJ 07030}
...
\section{HONORS AND \\ AWARDS}
    Member of Upsilon Pi Epsilon Honors Society\\
...
\section{EXPERIENCE} 
	...
	\begin{itemize}  \itemsep -2pt
		\item Creating systems to improve data review processes.
	\end{itemize}
