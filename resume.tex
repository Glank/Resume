...
\section{SKILLS AND\\EXPERTISE}
	{\sl Languages:}  C++ (9 months), Go (3 months), Python (2 years), Java (5+ years), PHP, JavaScript\\
	{\sl IDEs:}  Vim, Eclipse, Visual Studio\\

\section{EXPERIENCE} 
	{\sl Software Engineer} \hfill April 2015 - Present\\
	Google \hfill Jeremy Espenshade\\
	\quelle{espenshade@google.com}
	\begin{itemize}  \itemsep -2pt
		\item Creating systems to improve the review processes for changes to Google Maps.
	\end{itemize}

    {\sl Teacher's Assistant} \hfill September 2015 - Present\\
	TEALSK12 \hfill Nathan Granor\\
	\quelle{nathaniel@tealsk12.org}
	\begin{itemize}  \itemsep -2pt
